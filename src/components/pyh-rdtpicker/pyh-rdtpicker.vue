  ...
  methods: {
    ...
    init() {
      var that = this,
        pickerValue = ''
      if (
        (this.fields == 'year' && this.start.length != 4) ||
        (this.fields == 'month' && this.start.length != 7) ||
        (this.fields == 'day' && this.start.length != 10)
      ) {
        console.error('最小值格式与粒度格式不符')
        return
      } else if (
        (this.fields == 'year' && this.end.length != 4) ||
        (this.fields == 'month' && this.end.length != 7) ||
      ...
      var start =
          this.fields == 'year' ? this.start.slice(0, 4) : this.fields == 'month' ? this.start.slice(0, 7) : this.start,
      ...
      if (this[dateType]) {
        ...
        var dateTxt =
          this.fields == 'year'
            ...
            : this.yearArr[this.pickerValue[0]] +
              '-' +
              this.monthArr[this.pickerValue[1]] +
              '-' +
              this.dayArr[this.pickerValue[2]]
    ...
    pickerChangeMul(e) {
      ...
      this[this.dateType] =
        this.fields == 'year' ? dateTxt.slice(0, 4) : this.fields == 'month' ? dateTxt.slice(0, 7) : dateTxt
